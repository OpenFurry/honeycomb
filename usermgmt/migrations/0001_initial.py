    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('F', 'Favorite'), ('R', 'Rating'), ('E', 'Enjoy'), ('W', 'Watch'), ('M', 'Message'), ('S', 'Submission comment'), ('C', 'Comment reply'), ('P', 'Promote'), ('H', 'Highlight')], max_length=1)),
